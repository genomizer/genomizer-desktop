...
public class FileDrop {
                            ...
                            for (int zz = 0; zz < flavors.length; zz++) {
                                if (flavors[zz].isRepresentationClassReader()) {
                                    ...
                                    if (listener != null) listener
                                            .filesDropped(createFileArray(br,
                                                    out));
    ...
    /**
     * This is the event that is passed to the FileDropListener#filesDropped
     * filesDropped(...) method in your FileDropListener when files are dropped
    ...
    public static class TransferableObject implements
        ...
        public java.awt.datatransfer.DataFlavor[] getTransferDataFlavors() {
            if (customFlavor != null) return new java.awt.datatransfer.DataFlavor[] {
                    customFlavor, DATA_FLAVOR,
        ...
        public Object getTransferData(java.awt.datatransfer.DataFlavor flavor)
                ...
                java.io.IOException {
            // Native object
            if (flavor.equals(DATA_FLAVOR)) return fetcher == null ? data
                    : fetcher.getObject();
            
            // String
            if (flavor.equals(java.awt.datatransfer.DataFlavor.stringFlavor)) return fetcher == null
                    ? data.toString() : fetcher.getObject().toString();
