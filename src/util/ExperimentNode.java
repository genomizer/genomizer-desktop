 ...
 */
public class ExperimentNode extends AbstractMutableTreeTableNode {
	...
	public ExperimentNode(ExperimentData experiment) {
		super(experiment.getAnnotationValueList().toArray());
		...
		SupportNode profileNode = new SupportNode(new Object[] {"Profile Files"});
		profileNode.add(new SupportNode(fileHeaders));
		SupportNode regionNode = new SupportNode(new Object[] {"Region Files"});
