...
public class SearchTab extends JPanel {
	...
	gl.setHorizontalGroup(gl.createParallelGroup()
		...
		.addGroup(gl.createSequentialGroup()
			...
			.addGroup(gl.createParallelGroup(GroupLayout.Alignment.LEADING)
				...
				.addGroup(gl.createSequentialGroup()
					.addGroup(gl.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(expBox0)
						.addComponent(expBox3))
					.addGroup(gl.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(expBox1)
						.addComponent(expBox4))
					.addGroup(gl.createParallelGroup(GroupLayout.Alignment.LEADING)
                		                .addComponent(expBox2)
                		                .addComponent(expBox5))))
                	.addGroup(gl.createParallelGroup(GroupLayout.Alignment.LEADING)
	...
	String[] columnNames = { "Experiment ID", "Publication ID", "Species", "Sex"};
	Object[][] data = {
		    {"0", "1",
		     "Human", "F"},
		    {"1", "1",
