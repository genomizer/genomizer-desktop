...
/**
 * An interface implemented by the existing experiment panel and the
 * new experiment panel. This interface is used to connect the two panels.
 *
 * @author
 *
 */
public interface ExperimentPanel {
    ...
    /**
     * Method returning the current available genome releases
    ...
    /**
     * Deletes an uploadFileRow and calls a private repaint method. If
